...
const CLASSES = {
  ...
  Cleric: {
    promotesTo: 'Bishop',
    kind: 'cleric',
    caps: { hp: 60, str: 25, skl: 26, spd: 24, lck: 30, def: 21, res: 30, con: 20 },
    promo: { hp: 3, str: 2, skl: 1, spd: 1, def: 2, res: 3, con: 1 },
  },
  Shaman: {
    promotesTo: 'Druid',
...
const WEAPONS = [
  ...
  { name: 'Dagger', type: 'dagger', rank: 'D', mt: 1, hit: 95, wt: 1, crit: 0, magic: false, halfDef: true },
  ...
  { name: 'Elfire', type: 'anima', rank: 'C', mt: 10, hit: 85, wt: 10, crit: 0, magic: true },
  { name: 'Fimbulvetr', type: 'anima', rank: 'B', mt: 12, hit: 80, wt: 12, crit: 0, magic: true },
  ...
  { name: 'Divine', type: 'light', rank: 'C', mt: 8, hit: 85, wt: 12, crit: 10, magic: true },
